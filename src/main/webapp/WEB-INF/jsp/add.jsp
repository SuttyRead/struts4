...
<s:form action="/add" validate="false">
    ...
    <s:textfield name="login" class="form-control" label="Login" placeholder="Enter login" type="login"
                 pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{1,20}$"
                 required="true"/>

    <s:password name="password" class="form-control" label="Password" placeholder="Enter password"
                pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$"
                type="password" required="true"/>

    <s:password name="confirmPassword" class="form-control" label="Confirm Password"
                pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$"
    ...
    <s:textfield name="firstName" class="form-control" label="First Name" placeholder="Enter first name"
                 required="true"/>
    ...
    <s:select name="role" class="form-control" label="Role" list="{'USER', 'ADMIN'}" required="true"/>
